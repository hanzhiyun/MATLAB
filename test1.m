...
% Last Modified by GUIDE v2.5 15-Mar-2015 00:10:34
...
mass = handles.metricdata.edit6 * handles.metricdata.density * handles.metricdata.volume;
...
set(handles.edit6, 'String', handles.metricdata.edit6);
...
% Save the new edit6 value
handles.metricdata.edit6 = edit6;
guidata(hObject,handles)
% Hints: get(hObject,'String') returns contents of edit6 as text
%        str2double(get(hObject,'String')) returns contents of edit6 as a double
